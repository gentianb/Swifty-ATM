...
class DataSource{
   ...
   //let generalOptsRef = AdminOptionGeneralBalanceViewController()
    ...
    var standardUserLoggedInIndex = Int()
...
//        ref.childByAutoId().setValue(["userAccountNumber" : "\(userAccNumber)", "userAccountPIN" : "\(userAccPIN)", "userName" : "\(userName)", "userSurname" : "\(userSurname)" , "userBalance" : "\(userBalance)"])
        ref.childByAutoId().setValue(["userAccountNumber" : "\(userAccNumber)", "userAccountPIN" : "\(userAccPIN)", "userName" : "\(userName)", "userSurname" : "\(userSurname)" , "userBalance" : "\(userBalance)"]) { (err, ref) in
